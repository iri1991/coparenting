...
import { runRitualReminderJob } from "@/lib/cron-jobs";

/**
 * Cron: rulează per minut și trimite reminder pentru ritualurile cu ora curentă (HH:mm, Europe/Bucharest).
...
export async function GET(request: Request) {
  ...
  const result = await runRitualReminderJob(hh, date);
