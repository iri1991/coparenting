 ...
 *
 * Unauthenticated users are redirected to /login by this page.
 * Authenticated users land here after login/register.
 *
 * NOTE: The public marketing homepage lives at / (fully static SSG).
 * The middleware redirects authenticated users who visit / to /app.
 */
...
export const metadata: Metadata = {
  ...
  // Exclude the app page from search-engine indexing
...
export default async function AppPage({
  ...
  if (!session?.user?.id) {
    redirect(planParam ? `/login?plan=${planParam}` : "/login");
  }
