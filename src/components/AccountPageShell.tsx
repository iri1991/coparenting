...
export function AccountPageShell({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-orange-50 dark:from-stone-950 dark:to-stone-900">
      ...
      <div className="sm:hidden border-b border-stone-200/90 dark:border-stone-800/90 bg-white/92 dark:bg-stone-950/92 backdrop-blur-md pt-14">
        <div className="max-w-md mx-auto px-4 pb-3">{tabList}</div>
      </div>

      <header
        className={`hidden sm:block sticky top-0 z-40 border-b safe-area-inset-top transition-[background-color,box-shadow] duration-200 ${
          scrolled
