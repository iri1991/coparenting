...
export function SharedRitualsCard({ parent1Name, parent2Name }: SharedRitualsCardProps) {
  ...
  return (
    <section
      id="rituals"
      className="app-native-surface rounded-[2rem] p-4 scroll-mt-20 sm:p-5"
    >
            ...
            return (
              <li
                ...
                className={`rounded-xl border px-3 py-2 flex items-center justify-between gap-2 ${
                    ...
                    : "border-white/70 bg-white/76 shadow-[0_12px_26px_rgba(28,25,23,0.05)]"
                }`}
              >
                <label className="min-w-0 flex items-center gap-2 cursor-pointer">
                  ...
                  <span className="min-w-0">
                    <span className={`block text-sm font-medium ${done ? "text-emerald-800" : "text-stone-800"}`}>
                      {r.title}
                    </span>
                    <div className="mt-0.5 flex flex-wrap items-center gap-1.5">
                      {r.timeLabel && (
                        <span className="rounded-full bg-[#f6eee5] px-2 py-0.5 text-[11px] text-stone-600">
                          {r.timeLabel}
                        </span>
                      )}
                      <select
                ...
                <div className="flex items-center gap-1 shrink-0">
                  <button
                    ...
                    disabled={idx === 0}
                    className="app-native-icon-button rounded-xl px-2 py-1 text-xs text-stone-600 disabled:opacity-40"
                    title="Mută sus"
                  >
                    ↑
                  </button>
                  ...
                  <button
                    ...
                    className="rounded-xl border border-red-100 bg-white/80 px-2 py-1 text-xs text-red-600 hover:bg-red-50"
                    title="Șterge ritual"
                  >
      ...
      <div className="mb-4 rounded-[1.5rem] border border-white/70 bg-white/70 p-4">
        <div className="flex flex-wrap items-center justify-between gap-2 mb-2">
          <h3 className="text-sm font-semibold text-stone-900">Raport ritualuri</h3>
        ...
        <p className="mb-2 text-[11px] leading-relaxed text-stone-500">
          ...
          responsabil tot se numără. <strong className="text-stone-600">bifat / zile eligibile</strong>{" "}
      ...
      <div className="mb-4 rounded-[1.5rem] border border-white/70 bg-white/70 p-4">
        <p className="mb-2 text-xs font-semibold uppercase tracking-[0.14em] text-stone-400">Adaugă ritual</p>
        <div className="grid gap-2 sm:grid-cols-[1fr_7rem_10rem_8rem_auto]">
          ...
          <button
            ...
            className="app-native-primary-button inline-flex items-center justify-center gap-1 px-4 py-2.5 text-sm font-semibold disabled:opacity-50"
          >
      ...
      <div className="flex flex-wrap gap-2">
        {QUICK_TEMPLATES.map((t) => (
          <button
            ...
            className="app-native-secondary-button inline-flex items-center gap-1 px-3 py-2 text-xs font-semibold text-stone-700"
            title={`Adaugă „${t.title}”`}
          >
            <Check className="h-3.5 w-3.5 text-[#b85c3e]" />
